...
<?php
  ...
  $liste=$produit1C->retrieveProducts();
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4 item-v2">
            <a href="fiche-produit.php?id=<?php echo $row['id']; ?>"> <img src="<?php echo 'data:image/jpeg;base64,'.base64_encode($row['image']).'' ;?>" alt="Image"></a>
            <h3 class="text-dark"><a href="fiche-produit.php?id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a></h3>
            <p class="price"><?php echo $row['price']; ?> TND</p>
          </div>
          <?php } ?>
        </div>
        <div class="row mt-5">
