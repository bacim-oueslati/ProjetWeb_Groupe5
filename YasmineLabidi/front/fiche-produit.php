...
<head>
  ...
  $liste=$produit1C->retrieveProductById($id);
   ...
   <br>
    <div class="col-md-12">
      <div class="alert alert-danger" role="alert">
        Stock insuffisant ! Il reste <?php echo $qt; ?> produits !
      </div>
    </div>
<!--end of Info section -->
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="<?php echo 'data:image/jpeg;base64,'.base64_encode($image).'' ;?>" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p><strong class="text-primary h4"><?php echo $price; ?> TND</strong></p>
            <?php if ($qt>0){ ?>
            <p><strong class="text-primary h6">Disponible</strong></p>
            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 220px;">
                <form style="display: inherit;" action="add-cart.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                <div class="input-group-prepend">
                  <button class="btn btn-outline-primary js-btn-minus" type="button">&minus;</button>
                </div>
                <input type="text" class="form-control text-center" value="1" name="qt" placeholder=""
                ...
                <div class="input-group-append">
                  <button class="btn btn-outline-primary js-btn-plus" type="button">&plus;</button>
                        ...
                        <p><button type="submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Ajouter au Panier</button></p>

            </form>
          <?php }
          else if ($qt==0) { ?>
            <p><strong class="h4" style="color:red;">Stock épuisé</strong></p>
<?php } ?>
