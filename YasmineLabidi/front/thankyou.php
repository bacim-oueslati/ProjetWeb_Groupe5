          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="active"><a href="produits.php">Store</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <h2 class="display-3 text-black">Merci pour votre confiance !</h2>
            <p class="lead mb-5">Votre commande est passée</p>
            <p class="lead mb-5">Vous receverez bientôt un mail de confirmation de notre part</p> 
            <p><a href="produits.php" class="btn btn-md height-auto px-4 py-3 btn-primary">Vers boutique</a></p>
          </div>
        </div>
      </div>
    </div>
